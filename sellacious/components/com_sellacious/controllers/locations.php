...
class SellaciousControllerLocations extends SellaciousControllerAdmin
{
	...
	public function import()
	{
		...
		try
		{
			...
			$stats    = $app->getUserState('com_sellacious.locations.import.stats');
			$filename = $app->getUserState('com_sellacious.locations.import.file');
			...
			$pks = Joomla\Utilities\ArrayHelper::getColumn($stats, 'id');
		...
		// Clear state
		$app = JFactory::getApplication();
		$app->setUserState('com_sellacious.locations.import.file', null);
		$app->setUserState('com_sellacious.locations.import.stats', null);
	...
	public function analyzeImport()
	{
		...
		try
		{
			...
			{
				$app = JFactory::getApplication();
				$app->setUserState('com_sellacious.locations.import.file', base64_encode($filename));
				$app->setUserState('com_sellacious.locations.import.stats', $stats);
