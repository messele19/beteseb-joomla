...
class SellaciousControllerMedia extends SellaciousControllerBase
{
	...
	public function addFolder()
	{
		...
		$record = $app->input->post->get('jform', array(), 'array');
		...
		{
			$app->setUserState('com_sellacious.edit.media.newfolder', $record);
		...
		// clear session state
		$app->setUserState('com_sellacious.edit.media.newfolder', null);
	...
	public function delete()
	{
		...
		$app   = JFactory::getApplication();
		$files = $app->input->post->get('delete', array(), 'array');
		$total = count($files);
	...
	protected function getRedirectURL()
	{
		...
		$label  = $app->input->getString('label', null);
	...
	public function cropAjax()
	{
		// todo: verify this
		$app       = JFactory::getApplication();
		$image_id  = $app->input->getInt('img');
		$selection = $app->input->get('selection', array(), 'array');
