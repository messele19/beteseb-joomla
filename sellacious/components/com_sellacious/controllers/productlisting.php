...
class SellaciousControllerProductListing extends SellaciousControllerForm
{
	...
	protected function postSaveHook(JModelLegacy $model, $validData = array())
	{
		...
		{
			$app->setUserState('com_sellacious.edit.productlisting.data.seller_uid', $validData['seller_uid']);
		}
	...
	public function setType()
	{
		...
		$app->setUserState('com_sellacious.edit.productlisting.data', $post);
	...
	public function cancel($key = null)
	{
		...
		if (parent::cancel($key))
		{
			...
			$app->setUserState('com_sellacious.productlisting.products', null);
			$app->setUserState('com_sellacious.edit.productlisting.data.seller_uid', null);
		}
	}
}
