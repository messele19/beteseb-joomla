		...
		if ($this->getTask() == 'save2update' && $validData['fee_amount'] <= 0.00)
		{
			...
			try
			{
				...
				if ($listings)
				{
					...
					$app->enqueueMessage(JText::_('COM_SELLACIOUS_SPLCATEGORY_UPDATE_SUBSCRIPTION_SUCCESS'));
				}
			}
			catch (Exception $e)
			{
				$app->enqueueMessage(JText::sprintf('COM_SELLACIOUS_SPLCATEGORY_UPDATE_SUBSCRIPTION_FAILED', $e->getMessage()), 'warning');
			}
		}
	}
}
