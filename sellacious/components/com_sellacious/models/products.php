...
class SellaciousModelProducts extends SellaciousModelList
{
	...
	protected function populateState($ordering = null, $direction = null)
	{
		...
		$this->state->set('layout', JFactory::getApplication()->input->get('layout'));
	}
	...
	protected function getListQuery()
	{
		...
		$query->select('a.product_id AS id, a.product_id, a.seller_uid, a.owner_uid AS owned_by, a.product_title AS title, a.product_alias AS alias,'
	...
	protected function filterSearch($query)
	{
		...
		{
			$productsInCategory = 'SELECT product_id FROM #__sellacious_product_categories WHERE category_id = ' . (int) $category;
