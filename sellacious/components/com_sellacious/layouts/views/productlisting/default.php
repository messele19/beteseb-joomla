...
JHtml::_('script', 'com_sellacious/view.productlisting.js', false, true);

JHtml::_('stylesheet', 'com_sellacious/view.productlisting.css', null, true);
							...
							<ul class="dropdown-menu">
								...
								foreach ($fieldsets as $fs_key => $fieldset)
								{
									if ($visible[$fs_key])
									{
										$counter++;
										?>
										<li><a href="#tab-<?php echo $fs_key; ?>" data-toggle="tab"><?php
											echo JText::_($fieldset->label, true) ?></a></li><?php
									}
								}
								?>
							</ul>
