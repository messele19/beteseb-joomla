...
JHtml::_('script', 'com_sellacious/view.message.js', false, true);
JHtml::_('stylesheet', 'com_sellacious/view.message.css', null, true);
?>
<script>
					...
					<div class="panel-heading">
						<h4 class="panel-title">
							<a data-toggle="collapse" data-parent="#message-thread"
								...
								<strong>From: </strong><?php echo $this->helper->user->getFieldValue($message->sender, 'name') ?>
