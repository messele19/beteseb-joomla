...
$doc->addScript('templates/sellacious/js/plugin/bootstrap-wizard/jquery.bootstrap.wizard.js');
$doc->addScript('templates/sellacious/js/plugin/jquery-validate/jquery.validate.min.js');

JHtml::_('script', 'com_sellacious/view.activation.js', false, true);
					...
					<div id="activation-wizard" class="col-sm-12">
						...
						<div class="tab-content">
							<div class="tab-pane active" id="tab1">
								...
								<a class="alert-link pull-right padding-20-0 btn-have-license" href="javascript:void(0);"><span><?php
									echo JText::_('COM_SELLACIOUS_LICENCE_ENTER_KEY_BUTTON_LABEL'); ?></span><span class="hidden"><?php
							...
							<div class="tab-pane" id="tab2">
								...
								<a class="alert-link pull-right padding-20-0 btn-skip-verify" href="javascript:void(0);"><?php
