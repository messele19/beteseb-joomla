...
JHtml::_('script', 'com_sellacious/view.product.js', false, true);
JHtml::_('stylesheet', 'com_sellacious/view.product.css', null, true);
?>
						...
						foreach ($fieldsets as $fs_key => $fieldset)
						{
							if ($visible[$fs_key])
							{
								...
								<li class="<?php echo ($this->counter++) ? '' : ' active' ?> hidden-xs hidden-sm <?php echo $css ?>">
									<a href="#tab-<?php echo $fs_key; ?>" data-toggle="tab"><i class="fa fa-tasks"></i>
